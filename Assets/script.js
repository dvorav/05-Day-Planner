...
let same8 = moment(timeFormat).isSame("2020-11-02 08:35:32", "hour");
//Current time "isBefore" to the hour time
let before8 = moment(timeFormat).isBefore("2020-11-02 08:35:32", "hour");
//Current time "isAfter" to the hour time
let after8 = moment(timeFormat).isAfter("2020-11-02 08:35:32", "hour");
...
let same9 = moment(timeFormat).isSame("2020-11-02 09:35:32", "hour");
let before9 = moment(timeFormat).isBefore("2020-11-02 09:35:32", "hour");
let after9 = moment(timeFormat).isAfter("2020-11-02 09:35:32", "hour");
...
let same10 = moment(timeFormat).isSame("2020-11-02 10:35:32", "hour");
let before10 = moment(timeFormat).isBefore("2020-11-02 10:35:32", "hour");
let after10 = moment(timeFormat).isAfter("2020-11-02 10:35:32", "hour");
...
let same11 = moment(timeFormat).isSame("2020-11-02 11:35:32", "hour");
let before11 = moment(timeFormat).isBefore("2020-11-02 11:35:32", "hour");
let after11 = moment(timeFormat).isAfter("2020-11-02 11:35:32", "hour");
...
let same12 = moment(timeFormat).isSame("2020-11-02 12:35:32", "hour");
let before12 = moment(timeFormat).isBefore("2020-11-02 12:35:32", "hour");
let after12 = moment(timeFormat).isAfter("2020-11-02 12:35:32", "hour");
...
let same1 = moment(timeFormat).isSame("2020-11-02 13:35:32", "hour");
let before1 = moment(timeFormat).isBefore("2020-11-02 13:35:32", "hour");
let after1 = moment(timeFormat).isAfter("2020-11-02 13:35:32", "hour");
...
let same2 = moment(timeFormat).isSame("2020-11-02 14:35:32", "hour");
let before2 = moment(timeFormat).isBefore("2020-11-02 14:35:32", "hour");
let after2 = moment(timeFormat).isAfter("2020-11-02 14:35:32", "hour");
...
let same3 = moment(timeFormat).isSame("2020-11-02 15:35:32", "hour");
let before3 = moment(timeFormat).isBefore("2020-11-02 15:35:32", "hour");
let after3 = moment(timeFormat).isAfter("2020-11-02 15:35:32", "hour");
...
let same4 = moment(timeFormat).isSame("2020-11-02 16:35:32", "hour");
let before4 = moment(timeFormat).isBefore("2020-11-02 16:35:32", "hour");
let after4 = moment(timeFormat).isAfter("2020-11-02 16:35:32", "hour");
